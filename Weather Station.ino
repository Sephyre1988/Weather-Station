 ...
 * WIFI Settings
 **************************/
const char* WIFI_SSID = "Net2.4";
const char* WIFI_PWD = "Netdecasa";
...
const char* api_key = "OOHFGI7DAO2FF9MK";                  //Your own thingspeak api_key
...
String OPEN_WEATHER_MAP_APP_ID = "44d610c0fed7bd3231363645dda1422b";
String OPEN_WEATHER_MAP_LOCATION = "Peniche,PT";
...
void updateData(OLEDDisplay* display) {
    ...
    currentWeatherClient.updateCurrent(&currentWeather, OPEN_WEATHER_MAP_APP_ID, OPEN_WEATHER_MAP_LOCATION, client);
    drawProgress(display, 50, "Updating forecasts...");
    forecastClient.setMetric(IS_METRIC);
    forecastClient.setLanguage(OPEN_WEATHER_MAP_LANGUAGE);
    uint8_t allowedHours[] = { 12 };
    forecastClient.setAllowedHours(allowedHours, sizeof(allowedHours));
    forecastClient.updateForecasts(forecasts, OPEN_WEATHER_MAP_APP_ID, OPEN_WEATHER_MAP_LOCATION, MAX_FORECASTS, client);
...
void readAtmosphere() {
    ...
    currentWeather.pressure = tempAtom;
}
